...
cosmos_dirs = glob.glob(
    "/Users/deshima/hirado/ASTE2017/data/ASTE2017/LT119_FB3.3G_49ch/cosmos_*"
)
ddb_fits = (
    "/Users/deshima/workspace/takekoshi/ddb/toptica_20180612/DDB_20180619.fits.gz"
)
...
def mp_wrapper(cosmos_dir):
    ...
    try:
        mtd = MergeToDfits(
            ddb_fits, dfitsdict, obstinst, antennalog, rout_data, weatherlog, cabinlog
        )
