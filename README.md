...
- CPython: 3.9-3.12
- Dependent packages: [pyproject.toml](https://github.com/deshima-dev/demerge/blob/2.8.0rc1/pyproject.toml)をご確認ください
...
cd demerge && git checkout 2.8.0rc1
