...
- CPython: 3.9-3.12
- Dependent packages: [pyproject.toml](https://github.com/deshima-dev/demerge/blob/v2.6.0/pyproject.toml)をご確認ください
...
cd demerge && git checkout v2.6.0
