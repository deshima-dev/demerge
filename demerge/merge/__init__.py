...
def merge(
    ...
    **kwargs,
    ...
    obsinst_params = utils.load_obsinst(obsinst_path)
    ...
    times_cabin, _, lower_cabin_temp = utils.retrieve_cabin_temps(cabin_path)
    lower_cabin_temp = lower_cabin_temp + 273.15  # 度CからKへ変換

    times_weather = utils.convert_asciitime(
    ...
    times_antenna = utils.convert_asciitime(
